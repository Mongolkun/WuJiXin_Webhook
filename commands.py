...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "Ты вошёл в пространство **WuJiXing Quotes** — цифровое место, где цитаты и вопросы помогают открыть новые горизонты мышления.\n\n"
    "Задай свой вопрос и получи случайную мысль с помощью команды `/random`.\n"
    "Используй `/help` или посмотри **Меню**, если нужна помощь с навигацией.\n\n"
    "Здесь каждый шаг ведёт к новому пониманию. Двигайся, и путь откроется сам.",
